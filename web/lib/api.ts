  ...
  saveChat: (chat: Chat) =>
    request<Chat>(`/api/chats/${chat.id}`, {
      ...
      body: JSON.stringify({
        ...
        rollingSummaryEnabled: chat.rollingSummaryEnabled,
        rollingSummaryIntervalMinutes: chat.rollingSummaryIntervalMinutes,
        rollingSummaryMaxPerDay: chat.rollingSummaryMaxPerDay,
        rollingSummaryBotEnabled: chat.rollingSummaryBotEnabled,
