...
const textTranslations = {
  ...
  "在 Bot 推送设置中开启后，可将多个群组摘要合并为一篇。": "Enable this in Bot Delivery to combine multiple chat summaries into one digest.",
  "每日总览已选择，配置并启用 Bot 后才会开始生成。": "Daily Digest is selected and will start after the Bot is configured and enabled.",
  "等待 Bot 配置": "Waiting for Bot setup",
  "还没有每日总览记录": "No Daily Digest yet",
