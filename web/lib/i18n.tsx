...
const textTranslations = {
  ...
  "参与推送的群组全部完成后，会合并成一篇总览发送到 Telegram。": "After all participating chats finish, their summaries are combined into one Telegram digest.",
  "将参与推送的群组摘要合并成一篇，每天只接收一次 Telegram 推送。": "Combine participating chat summaries into one message and receive just one Telegram delivery each day.",
  ...
  "参与推送的群组仍会分别生成每日摘要，但不再逐条发送。系统会等待它们全部完成，再合并成一篇「每日总览」发送到 Telegram。": "Participating chats will still generate separate daily summaries, but those summaries will no longer be sent one by one. The system waits for all of them, combines them into one Daily Digest, and sends it to Telegram.",
  ...
  "参与 Bot 推送的群组会在全部完成后合并成一篇每日总览，不再单独发送。修改从保存当天的消息开始生效。": "Participating chats are combined into one Daily Digest after all finish and are not sent separately. Changes apply starting with messages from the day they are saved.",
