...
const textTranslations = {
  ...
  "当前 Telegram 账号下可管理的群组、超级群组与频道。": "Groups, supergroups, and channels available to the current Telegram account.",
  ...
  "关键词实时提醒": "Real-time keyword alerts",
  "提醒关键词": "Alert keywords",
  "每行一个，匹配到会立即通过 Bot 推送；同群同关键词 10 分钟内只提醒一次。": "One per line. Matching messages are sent via Bot immediately. Each keyword is throttled to one alert per 10 minutes per chat.",
  "空投\n上线\n崩盘": "airdrop\nlisting\ncrash",
  "空投 上线 崩盘": "airdrop listing crash",
  "关键词实时提醒依赖 Bot 推送配置，并且需要先启用消息保存。": "Real-time keyword alerts require Bot delivery to be configured and message saving enabled.",
  "群聊背景": "Chat context",
